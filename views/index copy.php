        ...
        <div class="accordion col-3" id="psAccordion">
            <div class="card">
                ...
                <div class="card-body collapse" data-parent="#psAccordion" id="psOptions">
                    <a href="search.php?search=playstation&category=ps"><h5 class="color">Playstation 1</h5></a>
                    <hr>    
                    <a href="search.php?search=playstation&category=ps"><h5 class="color">Playstation 2</h5></a>
                    <hr>
                    <a href="search.php?search=playstation&category=ps"><h5 class="color">Playstation 3</h5></a>
                    <hr>
                    <a href="search.php?search=playstation&category=ps"><h5 class="color">Playstation 4</h5></a>
                    <hr>
                    <a href="search.php?search=playstation&category=ps"><h5 class="color">PSP</h5></a>
                </div>
        ...
        <div class="accordion col-3" id="xbAccordion">
            <div class="card">
                ...
                <div class="card-body collapse" data-parent="#xbAccordion" id="xbOptions">
                    <a href="search.php?search=xbox&category=xb"><h5 class="color">Xbox Original</h5></a>
                    <hr>    
                    <a href="search.php?search=xbox&category=xb"><h5 class="color">Xbox 360</h5></a>
                    <hr>
                    <a href="search.php?search=xbox&category=xb"><h5 class="color">Xbox One</h5></a>
                </div>
        ...
        <div class="accordion col-3" id="nAccordion">
            <div class="card">
                ...
                <div class="card-body collapse" data-parent="#nAccordion" id="nOptions">
                    <a href="search.php?search=nintendo&category=n"><h5 class="color">NES</h5></a>
                    <hr>    
                    <a href="search.php?search=nintendo&category=n"><h5 class="color">Super NES</h5></a>
                    <hr>
                    <a href="search.php?search=nintendo&category=n"><h5 class="color">N64</h5></a>
                    <hr>
                    <a href="search.php?search=nintendo&category=n"><h5 class="color">Gamecube</h5></a>
                    <hr>
                    <a href="search.php?search=nintendo&category=n"><h5 class="color">Wii</h5></a>
                    <hr>
                    <a href="search.php?search=nintendo&category=n"><h5 class="color">Wii U</h5></a>
                    <hr>
                    <a href="search.php?search=nintendo&category=n"><h5 class="color">Switch</h5></a>
                    <hr>
                    <a href="search.php?search=nintendo&category=n"><h5 class="color">Gameboy</h5></a>
                </div>
        ...
        <div class="accordion col-3" id="rtAccordion">
            <div class="card">
                ...
                <div class="card-body collapse" data-parent="#rtAccordion" id="rtOptions">
                    <a href="search.php?search=atari&category=rt"><h5 class="color">Atari</h5></a>
                    <hr>    
                    <a href="search.php?search=sega&category=rt"><h5 class="color">Sega</h5></a>
                </div>
        ...
        <div class="row">
            <div class="join-banner text-center mt-5 col-12">
                <div class="banner-text">
                    ...
                    <h5 class="text-white">Doily’s even better when you're a member!</h5>

                    <p class="text-white mt-3">See listings more relevant to you, find what you're looking for faster and more! </p>
        ...
        <div class="row">
            <div class="join-banner text-center mt-5 col-12">
                <div class="banner-text">
                    ...
                    <a href="/search.php?+&category= All Categories" class="btnw mt-3">Search All</a>
